...
from azure.cognitiveservices.vision.face.model import TrainingStatusType,Person,SnapshotObjectType,OperationStatusType


KEY = os.environ['b5fdf6e51da14191b3fcb9df4de0fcc6']

ENDPOINT = os.environ['https://suneel.cognitiveservices.azure.com/']

# Create an authenticated FaceClient.
face_client = FaceClient('https://suneel.cognitiveservices.azure.com/', CognitiveServicesCredentials('b5fdf6e51da14191b3fcb9df4de0fcc6'))



# Detect a face in an image that contains a single face
single_face_image_url = 'https://images.app.goo.gl/GZUqiunmWKSVgaGu7'
...
multi_face_image_url = "https://images.app.goo.gl/GZUqiunmWKSVgaGu7"
